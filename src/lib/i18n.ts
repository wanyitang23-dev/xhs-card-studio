...
export interface Dict {
  ...
  "welcome.forkedFrom.prefix": string;
  "welcome.forkedFrom.suffix": string;
...
const en: Dict = {
  ...
  "welcome.description":
    "This tool turns an article into Xiaohongshu cards, one confirmed step at a time. It reuses the CLI session you are already logged into — no API key required. You can switch agents anytime from the top bar.",
  ...
  "welcome.enterTooltip.ok": "Start creating",
  "welcome.forkedFrom.prefix": "Forked from",
  "welcome.forkedFrom.suffix": ", reshaped into a step-by-step Xiaohongshu flow",
  ...
  "settings.titleAccent": "Xiaohongshu Studio",
  ...
  "settings.agent.subtitle":
    "This tool reuses your already-logged-in CLI session — no API key required.",
...
const zhCN: Dict = {
  ...
  "welcome.titleAccent": "code agent",
  "welcome.description":
    "把一篇文章分四步做成小红书图文,每一步都由你确认后才继续。复用你已经登录的 CLI session — 不要求你再贴一遍 API Key。你随时可以在右上角切换到别的 agent。",
  "welcome.rescan": "↻ 重新检测",
  ...
  "welcome.enterTooltip.ok": "开始做图",
  "welcome.forkedFrom.prefix": "派生自",
  "welcome.forkedFrom.suffix": "，改成小红书图文的分步流程",
  ...
  "settings.agent.title": "Code agent",
  "settings.agent.subtitle":
    "本工具复用你已经登录的 CLI session — 不需要再贴 API Key。",
